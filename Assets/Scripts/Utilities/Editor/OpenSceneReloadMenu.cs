/* This script generates the menu functions when reload is clicked.
 * All scenes you want to show up must be in the Build Settings.
 */
...
public class OpenSceneReloadMenu {
	...
	private static void ReloadThisMenu () {
	...
	private static void GenerateOpenSceneMenuScript () {
		...
		if (myPath == null) {
			...
			foreach (var scene in scenePaths) {
				...
				var sceneNameRaw = Regex.Replace (Path.GetFileNameWithoutExtension (scenePath), "_", ": ");
